...
|--------|---------|------------|-------|----------|-------|----------|
| 20s    | 96.3    | 97.7       | 26.2  | 27.1     | 2.13  | 2.71     |
| 30s    | 90.3    | 90.5       | 17.3  | 18.6     | 0.75  | 1.86     |
| 40s    | 97.3    | 97         | 19.1  | 17.6     | 0.68  | 1.76     |
| 50s    | 98.9    | 99.7       | 19.2  | 18.7     | 0.58  | 1.87     |
| 60s    | 105.6   | 106        | 21.2  | 22.6     | 057   | 2.26     |
| 70s    | 103.8   | 102        | 18.0  | 17.2     | 0.43  | 1.72     |
...
The following mean and standard deviation values are based on the most recent run of this function on 2/26

Height Mean Range: 65.87-68.99 Height Standard Deviation Range: 3.08-5.44

Weight Mean Range: 136.75-151.6 Weight Standard Deviation Range: 12.33-23.79

Age Mean Range: 19.04-21.24 Age Standard Deviation Range: 2.67-3.7

Number of Zombie Kills Mean Range: 2.4-3.56 Number of Zombie Kills Standard Deviation Range: 1.31-2.26

Years of Education Mean Range: 2.46-3.58 Years of Education Standard Deviation Range: 1.24-2.14

For all of my variables, compared to the first sample of 50, the standard deviations for the sampling distributions are higher than the standard errors calculated for the first sample fo 50 individuals. For example, the sample standard error for height was 0.59, while the range for the standard deviation from the sampling distribution was 3.08-5.44. The standard errors for the sample of 50 are as follows:

Height SE: 0.58\
Weight SE: 2.86\
Age SE: 0.42\
Number of Zombie Kills SE: 0.3\
Years of Education SE: 0.23\
